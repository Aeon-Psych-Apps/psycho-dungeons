...
This is my first "production" GitHub that I made specifically to host this project with since learning it could also function as a better patch and maintenance server. Originally, the patch server was fully contained within Tines, but I thought it was not optimized for long term viability based off current limitations/implementation).
